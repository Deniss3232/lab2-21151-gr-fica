...
fn draw_initial_pattern(fb: &mut Framebuffer) {
    let patterns = [
        (vec![(1,0), (2,1), (0,2), (1,2), (2,2)], 5, 5),       // Glider
        (vec![(0,1), (1,1), (2,1)], 20, 20),                   // Blinker
        (vec![(0,0), (0,1), (1,0), (1,1)], 40, 10),            // Block
        (vec![(1,0), (2,0), (3,0), (0,1), (1,1), (2,1)], 60, 5),// Toad
        (vec![(0,0), (0,1), (1,0), (2,3), (3,2), (3,3)], 70, 20),// Beacon
        (vec![(0,0), (1,0), (0,1), (2,1), (1,2)], 10, 40),      // Boat
        (vec![(1,0), (2,0), (0,1), (3,1), (1,2), (3,2), (2,3)], 25, 50), // Loaf
        (vec![(1,0), (0,1), (2,1), (1,2)], 45, 40),             // Tub
        (vec![(2,0), (3,0), (4,0), (0,2), (5,2), (0,3), (5,3), (0,4), (5,4), (2,5), (3,5), (4,5)], 65, 40), // Pulsar (center)
        (vec![(1,0), (4,0), (0,1), (0,2), (4,2), (0,3), (1,3), (2,3), (3,3)], 75, 60), // LWSS
    ];
